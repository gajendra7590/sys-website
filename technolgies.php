                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control xs-title" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Name" name="name">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="xs-title mb-2">Your Contact No.</label>
                                            <input type="text" class="form-control xs-title" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Contact No." name="contact">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1" class="xs-title mb-2">Your Email</label>
                                            <input type="email" class="form-control xs-title" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter Email" name="email">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            <label for="exampleInputPassword1" class="xs-title mb-2">Your Message</label>
                                            <textarea class="form-control xs-title" id="exampleFormControlTextarea1" rows="1" name="message"></textarea>
                                        </div>
                                    </div>
                                </div>
