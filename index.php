        ...
        <div class="container">
            ...
            <div class="row mt-2 mb-2">
                ...
                <div class="col-lg-6 col-md-12 col-sm-12">
                    <div class="sm-title">
                        About <span class="title-gray"> Systrail Solutions</span>
                    </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-12 col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control xs-title" aria-describedby="emailHelp" placeholder="Enter Email" name="email" id="contactEmail">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="about-services">
                                ...
                                <div class="element-content-box">
                                    ...
                                    <p class='mt-2 mb-3 title-gray xs-title'> <?php echo CONTACT ;?></p>
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12">
                            <div class="about-services">
                                ...
                                <div class="element-content-box">
                                    ...
                                    <p class='mt-2 mb-3 title-gray xs-title'> <?php echo SKYPE ;?></p>
